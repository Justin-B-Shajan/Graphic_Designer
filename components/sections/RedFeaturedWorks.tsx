  ...
  return (
    <section id="portfolio" ref={ref} className="relative">
        ...
        >
          {projects.map((project) => (
            ...
            >
              <Image
                src={project.image}
                alt={`${project.title} - ${project.category} Graphic Design work by Justin B Shajan`}
                width={320}
                height={256}
          ...
          {projects.map((project) => (
            ...
            >
              <Image
                src={project.image}
                alt={`${project.title} - ${project.category} Brand Marketing work by Justin B Shajan`}
                width={320}
                height={256}
                className="w-full h-full object-cover transition-transform duration-300 group-hover:scale-110"
              />
            ...
            {projects.slice(0, 6).map((project, index) => (
              ...
              >
                <div className="relative aspect-[4/5] rounded-lg overflow-hidden bg-gray-100 group-hover:shadow-2xl transition-all duration-500">
                  <Image
                    src={project.image}
                    alt={`${project.title} - ${project.category} portfolio project by Justin B Shajan, the best graphic designer and digital marketer`}
                    fill
      ...
      <div className="bg-[#B91C1C] py-16 sm:py-24 md:py-32 relative overflow-hidden">
        <div className="absolute top-0 left-0 right-0 py-4 z-0">
          <Marquee
          ...
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            ...
            <div className="relative aspect-[4/5] rounded-lg overflow-hidden shadow-2xl group order-1 lg:order-2">
              <Image
                ...
                alt={`${projects[3].title} - ${projects[3].category} advertisement design by Justin B Shajan, the top digital creative expert`}
                fill
      ...
      <div className="bg-white pt-16 sm:pt-20 pb-8 sm:pb-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {projects.slice(6).map((project, index) => (
              ...
              >
                <div className="relative aspect-[4/5] rounded-lg overflow-hidden bg-gray-100 group-hover:shadow-xl transition-all duration-500">
                  <Image
                    src={project.image}
                    alt={`${project.title} - ${project.category} campaign asset by Justin B Shajan, professional branding designer`}
                    fill
                    className="object-cover transition-transform duration-500 group-hover:scale-110"
                    sizes="(max-width: 768px) 100vw, (max-width: 1200px) 50vw, 33vw"
                  />
