      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          <a
            ...
            aria-label="Justin B Shajan — Go to top"
          >
            JUSTIN B SHAJAN
          </a>
        ...
        <div className="md:hidden bg-[#B91C1C]/95 backdrop-blur-xl border-t border-white/10">
          <div className="px-4 py-6 space-y-4">
            ...
            <a
              href="#contact"
              onClick={(e) => handleNavClick(e, '#contact')}
              className="block w-full px-6 py-3 border-2 border-white text-white font-semibold text-sm rounded-sm hover:bg-white/10 transition-all duration-300 text-center"
            >
              Let's Work Together
            </a>
          </div>
